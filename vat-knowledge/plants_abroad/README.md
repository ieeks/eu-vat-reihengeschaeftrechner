...
> **Aktueller Stand (25.08.2026): `Matrix_erweitert_V1_2.xlsx`** — eine Datei für beide
> Gesellschaften (EPDE Zeilen 3–44, EPROHA 45–65), mit den Spalten `Dreiecksgeschäft`,
> `L/S` (Lager/Strecke), gefülltem `tax code Miro` und den Findungsregeln als Kommentar in
> Zeile 1. `Matrix_erweitert_V1.xlsx` ist der Vorstand; die getrennten Dateien
> `Matrix_erweitert_EPDE.xlsx` / `..._EPROHA.xlsx` bleiben als Historie liegen.
> Prüfbericht + Rechner-Testlauf: [`PRUEFUNG.md`](PRUEFUNG.md) · `npm run check:matrix`
